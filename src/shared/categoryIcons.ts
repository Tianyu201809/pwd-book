...
const LETTER_ICON_PALETTE: { color: string; bg: string }[] = [
  ...
  { color: '#ea580c', bg: 'rgba(234, 88, 12, 0.22)' },
  { color: '#ca8a04', bg: 'rgba(202, 138, 4, 0.22)' },
  { color: '#eab308', bg: 'rgba(234, 179, 8, 0.22)' },
  { color: '#16a34a', bg: 'rgba(22, 163, 74, 0.22)' },
  { color: '#059669', bg: 'rgba(5, 150, 105, 0.22)' },
  { color: '#0d9488', bg: 'rgba(13, 148, 136, 0.22)' },
  { color: '#0891b2', bg: 'rgba(8, 145, 178, 0.22)' },
  { color: '#0284c7', bg: 'rgba(2, 132, 199, 0.22)' },
  { color: '#2563eb', bg: 'rgba(37, 99, 235, 0.22)' },
  { color: '#4338ca', bg: 'rgba(67, 56, 202, 0.22)' },
  { color: '#4f46e5', bg: 'rgba(79, 70, 229, 0.22)' },
  { color: '#7c3aed', bg: 'rgba(124, 58, 237, 0.22)' },
  { color: '#9333ea', bg: 'rgba(147, 51, 234, 0.22)' },
  { color: '#c026d3', bg: 'rgba(192, 38, 211, 0.22)' },
  { color: '#db2777', bg: 'rgba(219, 39, 119, 0.22)' },
  { color: '#e11d48', bg: 'rgba(225, 29, 72, 0.22)' },
  { color: '#be185d', bg: 'rgba(190, 24, 93, 0.22)' },
  { color: '#f43f5e', bg: 'rgba(244, 63, 94, 0.22)' },
  { color: '#64748b', bg: 'rgba(100, 116, 139, 0.22)' },
  { color: '#475569', bg: 'rgba(71, 85, 105, 0.22)' },
  { color: '#57534e', bg: 'rgba(87, 83, 78, 0.22)' },
  { color: '#334155', bg: 'rgba(51, 65, 85, 0.22)' },
  { color: '#1d4ed8', bg: 'rgba(29, 78, 216, 0.22)' },
  { color: '#15803d', bg: 'rgba(21, 128, 61, 0.22)' },
  { color: '#d97706', bg: 'rgba(217, 119, 6, 0.22)' },
]
