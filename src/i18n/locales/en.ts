export default {
  ...
  notes: {
    ...
    emptyHint: 'Create one and capture what matters now.',
    noSelection: 'Select a note to start editing',
    saved: 'Saved',
    saving: 'Saving…',
    saveFailed: 'Save failed. Try again.',
    copy: 'Copy note',
    copied: 'Full note copied',
    copiedShort: 'Copied',
    ...
    moveTo: 'Move to',
    moveToBook: 'Move to notebook',
    moveFailed: 'Could not move note. Try again.',
    color: 'Note color',
    textBlock: 'Text',
    checklistBlock: 'Checklist',
    blockType: 'Block type',
    newBlock: 'New block',
    convertToChecklist: 'Turn into checklist',
    convertToText: 'Turn into text',
    toggleChecked: 'Toggle checklist item',
    openFailed: 'Could not open notes. Unlock the vault and try again.',
    loadFailed: 'Failed to load notes',
    retry: 'Retry',
    renameBook: 'Rename notebook',
    renameBookTitle: 'Rename notebook',
    bookNamePlaceholder: 'Notebook name',
    deleteBook: 'Delete notebook',
    deleteBookMove: 'Move to the default notebook',
    deleteBookTrash: 'Move notes to trash',
    confirmDeleteBook: 'Delete the notebook “{name}”?',
    confirmDeleteBookNotes: 'This notebook has {count} notes. Choose what happens to them:',
    confirmDelete: 'Delete this note? You can restore it from trash.',
    confirmDeletePermanent: 'This permanently deletes the note. Continue?',
    contentInvalid: 'This note cannot be decrypted or is damaged. Editing is locked so the original is not overwritten.',
  },
  errors: {
    ...
    shortcut_invalid: 'Invalid shortcut. Use Ctrl, Alt, or the Windows key plus one key',
    shortcut_conflict: 'This shortcut is already assigned to another feature',
    shortcut_in_use: 'This shortcut is already used by the system or another app',
  },
  titlebar: {
  ...
  productTour: {
    ...
    steps: {
      ...
      tools: {
        ...
        clipboard: {
          title: 'Clipboard',
          body: 'Opens a popup for recently copied text and images. Turn on history in Settings → Clipboard first. You can also use the shortcut from Settings or the title-bar button.',
        },
        trash: {
          title: 'Trash',
  ...
  tools: {
    ...
    clipboardSubtitle: 'Keep copied content close, with automatic cleanup for sensitive items.',
    clipboardCapture: 'Read system clipboard',
    clipboardNew: 'New text',
    clipboardText: 'Text',
    clipboardImages: 'Images',
    clipboardPinned: 'Pinned',
    clipboardFavorites: 'Favorites',
    clipboardLocalOnly: 'Stored on this device only',
    ...
    clipboardPreviewShortcut: 'Enlarge preview (Ctrl+Enter)',
    clipboardMenuPreview: 'Preview',
    clipboardTitleEdit: 'Edit title',
    clipboardTitleEditDesc: 'Set a recognizable title for this clipboard record.',
    clipboardTitlePlaceholder: 'Enter a title (leave empty to use the default)',
    clipboardTitleSave: 'Save title',
    ...
    clipboardPin: 'Fix item',
    clipboardFavorite: 'Favorite',
    clipboardUnfavorite: 'Remove from favorites',
    clipboardFavoriteEmptyTitle: 'No favorites yet',
    clipboardFavoriteEmptyDesc: 'Click the star on an item to keep important content here.',
    clipboardExpires: 'Auto clear',
    clipboard30s: 'In 30 seconds',
    clipboard5m: 'In 5 minutes',
    clipboard15m: 'In 15 minutes',
    clipboard30m: 'In 30 minutes',
    clipboardNever: 'Never',
    clipboardCopy: 'Copy content',
    clipboardSelectHint: 'Select an item to inspect its full content',
    clipboardCaptureTitle: 'Write clipboard record',
    clipboardPlaceholder: 'Paste or type content to keep…',
    ...
    clipboardWindowDrag: 'Drag the title bar to move the window',
  ...
  settings: {
    ...
    notesManagerShortcutDesc: 'Global shortcut to open or hide the notes manager. When the vault is locked, it shows the main window first so you can unlock.',
    shortcutSection: 'Launch shortcut',
    shortcutSectionDesc: 'Click the key well, then press a new chord. Use Ctrl, Alt, or Win, and keep it different from the other three.',
    shortcutSlotNotes: 'Notes',
    shortcutSlotClipboard: 'Clipboard',
    shortcutSlotQuickBar: 'Quick bar',
    shortcutSlotMain: 'Main window',
    shortcutCapture: 'Click to record',
    shortcutListening: 'Press a chord',
    shortcutReset: 'Reset',
    shortcutSaved: 'Updated',
    shortcutNeedsModifier: 'Hold Ctrl, Alt, or the Windows key',
    shortcutNeedsModifierMac: 'Hold Ctrl, Option, or Command',
    shortcutUnsupported: 'That key cannot be a global shortcut',
    shortcutConflict: 'Already used by {name}',
    shortcutHint: 'Esc cancels',
    shortcutAria: 'Current shortcut {accelerator}. Click, then press a new chord',
    clipboardShortcutDesc: 'Global shortcut to open or hide the clipboard window.',
    ...
    quickBarStatusOn: 'On',
    quickBarStatusOff: 'Off',
    quickBarPolicyShortcut: 'Open quick bar',
    quickBarPolicyLimit: 'Item limit',
    quickBarPolicyMain: 'Show main window',
    quickBarRulesTitle: 'Quick bar rules',
    trashTab: 'Recycle bin',
    trashModuleTitle: 'Recycle bin',
    trashModuleLead: 'Manage how long deleted entries stay before they are permanently removed.',
    trashOpen: 'Open recycle bin',
    trashPolicyKeep: 'Keep for',
    trashRulesTitle: 'Retention',
    ...
    clipboardGuide: {
      ...
      subtitle: 'Learn how to capture, retrieve, and keep items',
      stepOf: 'Step {current} of {total}',
      prev: 'Back',
      next: 'Next',
      finish: 'Done',
      alreadyEnabled: 'Clipboard history is already on',
      readyHint: 'All set. Unlock, copy something, then open the window to retrieve it.',
      steps: [
        {
          title: 'Turn on clipboard history',
          desc: 'Enable “Clipboard history” on this page. It then captures system text and images. When off, monitoring stops; you can still create a text note by hand.',
          tip: 'History stays on this device — not in the vault, and not in sync.',
        },
        {
          title: 'Open the clipboard window',
          desc: 'After unlock, press {accelerator} or click “Open clipboard window”. The title bar and toolbox also open it.',
        ...
        },
        {
          ...
          desc: 'Copied text and images appear in the list. Duplicates are merged. You can also create a text note by hand.',
          tip: 'This is separate from “Clear clipboard” under Settings → Security, which only clears a copied password.',
        },
        {
        ...
        {
          title: 'Pin and keep',
          desc: 'Pinned items skip expiry and stay when the item cap is reached. History is session-only by default.',
          tip: 'Turn on persistence to keep history after shutdown or restart.',
        },
        {
          title: 'Start using',
          desc: 'Keep the switch on, copy something, then retrieve it from the window. Pin items you want to keep longer.',
          tip: 'The window hides when the vault locks. Open it again after unlock.',
        },
      ],
      visual: {
        enableLabel: 'Clipboard history',
        captureHint: 'Just copied',
        persistHint: 'Optional persist',
    ...
    clipboardEnabledDesc: 'Capture copied text and images. When off, clipboard monitoring stays disabled at startup.',
    ...
    clipboardExpiry5m: '5 minutes',
    clipboardExpiry15m: '15 minutes',
    clipboardExpiry30m: '30 minutes',
    clipboardExpiryNever: 'Never',
    clipboardPersistence: 'Persist clipboard data',
    clipboardPersistenceDesc: 'Keep clipboard history after shutting down or restarting the app.',
    clipboardHistoryLimit: 'History item limit',
    clipboardHistoryLimitDesc: 'When the limit is reached, the oldest unpinned items are removed first. Pinned items are kept.',
    clipboardHistoryLimitOption: '{n} items',
    ...
    quickBarDesc: 'A slim bar at the top of the screen; Enter launches a local program, opens the URL, or focuses the entry in the main window.',
    quickBarShortcutDesc: 'Global shortcut to open or hide the floating search bar.',
    ...
    quickBarRecentLimitOption: '{n} items',
    emailBackupOpen: 'Open email backup',
    mainWindowShortcut: 'Shortcut to show main window',
    mainWindowShortcutDesc: 'When on, a global shortcut shows and focuses the main window.',
    mainWindowShortcutKey: 'Main window shortcut',
    mainWindowShortcutKeyDesc: 'Change the chord that shows the main window.',
