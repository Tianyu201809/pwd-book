...
| 能力 | 说明 |
|------|------|
| **分类** | 内置「全部」「收藏」与自定义分类；侧栏拖拽排序（顺序持久化）；搜索框旁 **「+」** 快速新建；**分类管理**面板内联改名、点图标更换；**自定义分类右键**可编辑、删除（仅空分类可删，有条目时禁用并提示） |
...
| **侧栏工具区** | 「工具与设置」默认收起（展开状态写入 `localStorage`），可进入邮箱备份、随机密码；侧栏底部另有回收站、设置、锁定 |
