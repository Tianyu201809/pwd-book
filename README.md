...
从侧栏进入 **设置**。**v1.33.0** 起分为：**安全 / 剪切板 / 浏览器 / 悬浮条 / 回收站 / 外观 / 数据 / 关于**。
...
| 设置中心 | 设置分区导航，以及安全 / 剪切板 / 浏览器 / 悬浮条 / 回收站 / 数据 |
...
- **桌面便签**（**v1.38.0**） — 从管理窗弹出；无系统边框，可置顶；关闭只隐藏；锁定保险库时全部隐藏，解锁后恢复。见 [便签](#便签-v1380)
